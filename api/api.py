...
from agents.macoder.api import setup_routes as setup_macoder_routes
from agents.cody.api import setup_routes as setup_cody_routes
...
class APIServer:
    ...
    async def start(self) -> bool:
        ...
        try:
            ...
            setup_macoder_routes(self.app)
            setup_cody_routes(self.app)
