...
class UnifiedInput {
    ...
    initializeUI() {
        ...
        this.inputContainer.innerHTML = `
            ...
            <div class="input-tools d-flex justify-content-between align-items-center">
                <div class="input-tools-left">
                    <button id="voice-button" class="btn btn-outline-secondary tool-button" title="Voice Input">
                        <i class="fas fa-microphone"></i>
                    </button>
                    <button id="upload-button" class="btn btn-outline-secondary tool-button" title="Upload Files">
                        <i class="fas fa-upload"></i>
                    </button>
                    <input type="file" id="file-upload" multiple style="display: none;">
                </div>
                <div class="input-tools-center">
                ...
                <div class="input-tools-right">
                    <button id="research-button" class="btn btn-outline-secondary tool-button" title="Deep Research">
                        <i class="fas fa-search"></i>
                    </button>
                    <button id="think-button" class="btn btn-outline-secondary tool-button" title="Deep Thinking Mode">
